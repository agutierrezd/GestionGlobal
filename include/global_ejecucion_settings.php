...
//	global_ejecucion_desagregada
	
	

		$dIndex = 0;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="global_ejecucion_desagregada";
		$detailsParam["dOriginalTable"] = "global_ejecucion_desagregada";



				$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "global_ejecucion_desagregada";
	$detailsParam["dCaptionTable"] = GetTableCaption("global_ejecucion_desagregada");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();


		
	$detailsTablesData["global_ejecucion"][$dIndex] = $detailsParam;

	
		$detailsTablesData["global_ejecucion"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["global_ejecucion"][$dIndex]["masterKeys"][]="UEJ";

	$detailsTablesData["global_ejecucion"][$dIndex]["masterKeys"][]="TIPO";

	$detailsTablesData["global_ejecucion"][$dIndex]["masterKeys"][]="RUBRO";

				$detailsTablesData["global_ejecucion"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["global_ejecucion"][$dIndex]["detailKeys"][]="UEJ";

		
	$detailsTablesData["global_ejecucion"][$dIndex]["detailKeys"][]="TIPO";

		
	$detailsTablesData["global_ejecucion"][$dIndex]["detailKeys"][]="RUB";
//	global_ejecucion_actividades_spi
	
	

		$dIndex = 1;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="global_ejecucion_actividades_spi";
		$detailsParam["dOriginalTable"] = "global_ejecucion_actividades_spi";



				$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "global_ejecucion_actividades_spi";
	$detailsParam["dCaptionTable"] = GetTableCaption("global_ejecucion_actividades_spi");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();
	...
	$detailsTablesData["global_ejecucion"][$dIndex]["masterKeys"][]="CODIGO_BPIN";

				$detailsTablesData["global_ejecucion"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["global_ejecucion"][$dIndex]["detailKeys"][]="codigoBPINProyecto";

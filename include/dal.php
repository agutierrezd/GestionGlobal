...
class tDAL
{
	...
	var $tbledl_at_localhost__gestionglobal_ver_103_audit;
	var $tbledl_at_localhost__gestionglobal_ver_103_locking;
	var $tbledl_at_localhost__gestionglobal_ver_103_uggroups;
	var $tbledl_at_localhost__gestionglobal_ver_103_ugmembers;
	var $tbledl_at_localhost__gestionglobal_ver_103_ugrights;
	...
	var $tbldbct_at_localhost__contrato_otrosi_type;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "dependencia_det", "varname" => "edl_at_localhost__dependencia_det", "altvarname" => "dependencia_det", "connId" => "edl_at_localhost", "schema" => "", "connName" => "edl at localhost");
		...
		$this->lstTables[] = array("name" => "gestionglobal_ver_103_audit", "varname" => "edl_at_localhost__gestionglobal_ver_103_audit", "altvarname" => "gestionglobal_ver_103_audit", "connId" => "edl_at_localhost", "schema" => "", "connName" => "edl at localhost");
		$this->lstTables[] = array("name" => "gestionglobal_ver_103_locking", "varname" => "edl_at_localhost__gestionglobal_ver_103_locking", "altvarname" => "gestionglobal_ver_103_locking", "connId" => "edl_at_localhost", "schema" => "", "connName" => "edl at localhost");
		$this->lstTables[] = array("name" => "gestionglobal_ver_103_uggroups", "varname" => "edl_at_localhost__gestionglobal_ver_103_uggroups", "altvarname" => "gestionglobal_ver_103_uggroups", "connId" => "edl_at_localhost", "schema" => "", "connName" => "edl at localhost");
		$this->lstTables[] = array("name" => "gestionglobal_ver_103_ugmembers", "varname" => "edl_at_localhost__gestionglobal_ver_103_ugmembers", "altvarname" => "gestionglobal_ver_103_ugmembers", "connId" => "edl_at_localhost", "schema" => "", "connName" => "edl at localhost");
		$this->lstTables[] = array("name" => "gestionglobal_ver_103_ugrights", "varname" => "edl_at_localhost__gestionglobal_ver_103_ugrights", "altvarname" => "gestionglobal_ver_103_ugrights", "connId" => "edl_at_localhost", "schema" => "", "connName" => "edl at localhost");
		...
		$this->lstTables[] = array("name" => "contrato_natjuridica", "varname" => "dbct_at_localhost__contrato_natjuridica", "altvarname" => "contrato_natjuridica", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at localhost");
		$this->lstTables[] = array("name" => "contrato_otrosi_type", "varname" => "dbct_at_localhost__contrato_otrosi_type", "altvarname" => "contrato_otrosi_type", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at localhost");
		...
		$this->lstTables[] = array("name" => "global_month", "varname" => "dbct_at_localhost__global_month", "altvarname" => "global_month", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at localhost");
		...
		$this->lstTables[] = array("name" => "tipo_liquidacion", "varname" => "dbct_at_localhost__tipo_liquidacion", "altvarname" => "tipo_liquidacion", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at localhost");
		...
		$this->lstTables[] = array("name" => "tparam_estcivil", "varname" => "dbct_at_localhost__tparam_estcivil", "altvarname" => "tparam_estcivil", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at localhost");
		...
		$this->lstTables[] = array("name" => "ep_agregada", "varname" => "sep2_at_localhost__ep_agregada", "altvarname" => "ep_agregada", "connId" => "sep2_at_localhost", "schema" => "", "connName" => "sep2 at localhost");
		...
		$this->lstTables[] = array("name" => "q_graph_001", "varname" => "sep2_at_localhost__q_graph_001", "altvarname" => "q_graph_001", "connId" => "sep2_at_localhost", "schema" => "", "connName" => "sep2 at localhost");
		$this->lstTables[] = array("name" => "q_graph_002", "varname" => "sep2_at_localhost__q_graph_002", "altvarname" => "q_graph_002", "connId" => "sep2_at_localhost", "schema" => "", "connName" => "sep2 at localhost");
